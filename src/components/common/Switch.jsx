...
function Switch() {
  ...
  return (
    <>
      <section
        className={` w-full ${banner_bg} bg-repeat py-30 px-10  md:hidden lg:hidden`}
      >
      ...
      <section
        className={`hidden w-full ${banner_bg} bg-repeat md:flex md:items-center md:justify-center lg:flex lg:items-center lg:justify-center `}
      >
        <div className="btn-group-desktop flex items-center justify-between py-30.5 px-45.5 ">
          <div className={`group-rocket-desktop flex flex-col cursor-pointer transform-all duration-300 ${isSelected !== isRocket ? "hover:-mt-4" : ""}`}>
            <div
            ...
            >
              ...
              <div
                ...
                ${!(isSelected === isRocket) ? "opacity-60" : ""}`}
              >
                <p className="h1">火箭隊</p>
                <p className=" h4 text-Neutral-500 ">Bootcamp Rocket</p>
              </div>
              <div className="rocket-icon-desktop pt-6 pb-4">
                <img className="object-contain" src={rocket_lg} alt="rocket" />
              </div>
              <div className="rocket-tag-desktop flex flex-col justify-center items-center">
          ...
          <div className="btn-and py-8.5 px-20.5">
            <p className="h1">X</p>
          </div>
          <div className={`group-workspace-desktop flex flex-col cursor-pointer transform-all duration-300 ${isSelected !== isWorkspace ? "hover:-mt-4" : ""}`}>
            <div
            ...
            >
              ...
              <div
                className={`workspace-title-desktop flex flex-col items-center justify-center -mt-33 z-30 ${
                  !(isSelected === isWorkspace) ? "opacity-60" : ""
                }`}
              >
                <p className="h1">共同空間</p>
                <p className=" h4 text-Neutral-500 ">Co-working Space</p>
              </div>
              <div className="workspace-icon-desktop pt-6 pb-4">
                <img
              ...
              <div className="workspace-tag-desktop flex flex-col justify-center items-center">
